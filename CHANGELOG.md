...
## [0.1.1](https://github.com/CedricLuccheseDev/Musaic/compare/v0.1.0...v0.1.1) (2026-01-29)
...
* **web:** add set builder for creating DJ sets ([7f03463](https://github.com/CedricLuccheseDev/Musaic/commit/7f034633b3a23321fc5dad8874a806e38e58bc60))
...
* **web:** implement BroadcastChannel for cross-tab auth communication ([092b16d](https://github.com/CedricLuccheseDev/Musaic/commit/092b16d726f50a59d354ffe5e5af98b696adf0f6))
* **web:** sync SoundCloud likes to database ([c99b795](https://github.com/CedricLuccheseDev/Musaic/commit/c99b795161971eae86ad3400a6863f0e8523299c))
...
* **web:** display SoundCloud username instead of generated email ([a9a0fce](https://github.com/CedricLuccheseDev/Musaic/commit/a9a0fcede68202fab807c3605647381c7782cef3))
...
* **web:** use HMAC-signed state instead of cookies for OAuth CSRF ([6416d80](https://github.com/CedricLuccheseDev/Musaic/commit/6416d80b5ac1b57c85fb16f73f7f9692609091f1))
* **web:** use token_hash for magic link verification ([85bdb02](https://github.com/CedricLuccheseDev/Musaic/commit/85bdb029d57d562c10124aaf399f1d580d365502))
