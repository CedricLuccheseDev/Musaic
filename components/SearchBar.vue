  ...
  <div class="relative flex w-full items-center">
    ...
    >
      ...
      <input
        v-model="searchInput"
        type="text"
        :placeholder="searchArtist ? 'Rechercher un artiste...' : 'Rechercher un titre...'"
        class="flex-1 bg-transparent px-3 text-white placeholder-neutral-500 outline-none"
      ...
      <button
        type="button"
        class="mx-2 flex cursor-pointer items-center gap-1.5 rounded-xl px-3 py-1.5 text-sm font-medium transition-all duration-200"
        :class="searchArtist
      ...
      <button
        type="button"
        class="m-1.5 flex cursor-pointer items-center gap-2 rounded-xl bg-violet-600 px-4 py-2 font-medium text-white transition-all duration-200 hover:bg-violet-500"
        :class="size === 'large' ? 'px-6 py-3' : 'px-4 py-2'"
        @click="onSearch"
      >
