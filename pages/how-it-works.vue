...
<template>
  <div class="min-h-screen bg-neutral-950 lg:p-8">
    <!-- Header -->
    <PageHeader class="relative z-50">
      <template #back>
        <NuxtLink
          to="/"
          class="flex h-8 w-8 items-center justify-center rounded-full border border-neutral-700 text-neutral-400 transition-all hover:border-violet-500 hover:text-white"
        >
