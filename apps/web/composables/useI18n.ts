...
const translations = {
  fr: {
    ...
    // Set Builder
    setMySets: 'Mes sets',
    setCreateSet: 'Créer un set',
    setNewSet: 'Nouveau set',
    setName: 'Nom du set',
    setNamePlaceholder: 'Mon set dubstep été 2024',
    setGenre: 'Genre',
    setGenrePlaceholder: 'Rechercher un genre...',
    setDuration: 'Durée cible',
    setMood: 'Ambiance',
    setMoodEnergetic: 'Énergique',
    setMoodChill: 'Chill',
    setMoodProgressive: 'Progressive',
    setMoodMixed: 'Mixte',
    setFreeOnly: 'Free download uniquement',
    setStartCreation: 'Commencer la création',
    setSuggestions: 'Suggestions',
    setSuggestionsRefresh: 'Rafraîchir',
    setSearchResults: 'Résultats',
    setNoSuggestions: 'Aucune suggestion disponible',
    setAddTrack: 'Ajouter',
    setRemoveTrack: 'Supprimer',
    setTrackRemoved: 'Track supprimée',
    setUndo: 'Annuler',
    setSearchPlaceholder: 'Rechercher une track...',
    setNoSets: 'Aucun set créé',
    setNoSetsDesc: 'Crée ton premier set DJ',
    setDuplicate: 'Dupliquer',
    setRename: 'Renommer',
    setDelete: 'Supprimer',
    setDeleteConfirm: 'Supprimer ce set ?',
    setDeleteConfirmDesc: 'Cette action est irréversible.',
    setCancel: 'Annuler',
    setTracks: 'tracks',
    setProgress: 'Progression',
    setExport: 'Exporter',
    setDownloads: 'Téléchargements',
    setDownloadTracks: 'Télécharger les tracks',
    setFreeDownloads: 'Téléchargements gratuits',
    setExternalLinks: 'Liens externes',
    setNoFreeDownload: 'Pas de téléchargement gratuit',
    setPremiumLimit: 'Passe Premium pour créer plus de sets',
  ...
  en: {
    ...
    // Set Builder
    setMySets: 'My sets',
    setCreateSet: 'Create set',
    setNewSet: 'New set',
    setName: 'Set name',
    setNamePlaceholder: 'My summer dubstep set 2024',
    setGenre: 'Genre',
    setGenrePlaceholder: 'Search a genre...',
    setDuration: 'Target duration',
    setMood: 'Mood',
    setMoodEnergetic: 'Energetic',
    setMoodChill: 'Chill',
    setMoodProgressive: 'Progressive',
    setMoodMixed: 'Mixed',
    setFreeOnly: 'Free download only',
    setStartCreation: 'Start creation',
    setSuggestions: 'Suggestions',
    setSuggestionsRefresh: 'Refresh',
    setSearchResults: 'Results',
    setNoSuggestions: 'No suggestions available',
    setAddTrack: 'Add',
    setRemoveTrack: 'Remove',
    setTrackRemoved: 'Track removed',
    setUndo: 'Undo',
    setSearchPlaceholder: 'Search for a track...',
    setNoSets: 'No sets created',
    setNoSetsDesc: 'Create your first DJ set',
    setDuplicate: 'Duplicate',
    setRename: 'Rename',
    setDelete: 'Delete',
    setDeleteConfirm: 'Delete this set?',
    setDeleteConfirmDesc: 'This action cannot be undone.',
    setCancel: 'Cancel',
    setTracks: 'tracks',
    setProgress: 'Progress',
    setExport: 'Export',
    setDownloads: 'Downloads',
    setDownloadTracks: 'Download tracks',
    setFreeDownloads: 'Free downloads',
    setExternalLinks: 'External links',
    setNoFreeDownload: 'No free download',
    setPremiumLimit: 'Go Premium to create more sets',
    setLoading: 'Loading...',
    setError: 'Error'
  }
} as const
